    ...
    <div>
      ...
      <footer>
        <div class="container">
          ...
          <nav id="footerNav">
            <a href="#top">Back to top</a> | <a href="">FAQ</a> |
            <a href="">Privacy Agreement</a> | <a href>Contact</a>
          </nav>
        </div>
      </footer>
    </div>
...
export default {
  ...
  created() {
    ...
    apiClient
      .get("http://mywebapp-775f4.ue.r.appspot.com/shows", { headerTokens })
      .then((response) => {
  ...
  methods: {
    ...
    getPresentations: function (id) {
      ...
      apiClient
        .get(
          "http://mywebapp-775f4.ue.r.appspot.com/shows/" +
            id +
            "/presentations",
          { headerTokens }
        )
    ...
    filteredFilms: function () {
      ...
      return this.shows.filter(
        (show) =>
          show.name
            .toLowerCase()
            .includes(this.searchTitleText.toLowerCase()) &&
          show.description
            .toLowerCase()
